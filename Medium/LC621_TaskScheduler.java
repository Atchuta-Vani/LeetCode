...
- idles are slots where we don't have any tasks to fill with. Math.max(0, emptySlots - ava
...
class Solution {
    public int leastInterval(char[] tasks, int n) {
        ...
        int sectionCount = maxFreq -1;
        int sectionLength = n - (maxCount - 1);
        int emptySlots = sectionCount * sectionLength;
